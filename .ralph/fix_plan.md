...
- [ ] **12.2** Deploy portal to Vercel — run `vercel` to link and deploy. Configure root directory to `portal/`, set environment variables. Verify build succeeds, auth flow works, Socket.IO connects to Railway server
